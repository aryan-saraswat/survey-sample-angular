export function init(Survey: any) {
    var widget = {
      ...
      isFit: function (question: { getType: () => string; }) {
      ...
      afterRender: function (question: { inputType: any; placeHolder: any; buttonText: any; value: string; isReadOnly: any; readOnlyChangedCallback: () => void; valueChangedCallback: () => void; }, el: { getElementsByTagName: (arg0: string) => any[]; }) {
